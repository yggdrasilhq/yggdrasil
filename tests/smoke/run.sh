...
check_contains "scripts/mkconfig-core.sh" "YGG_ENABLE_INTEL_ARC_SRIOV"
check_contains "scripts/mkconfig-core.sh" "9190-install-intel-arc-sriov-dkms.hook.chroot"
check_contains "scripts/mkconfig-core.sh" "9191-configure-intel-arc-sriov.hook.chroot"
check_contains "scripts/mkconfig-core.sh" "i915.max_vfs="
...
check_contains "ygg.example.toml" "enable_intel_arc_sriov = false"
check_contains "scripts/build-profile.sh" "YGG_ENABLE_INTEL_ARC_SRIOV"
check_contains "scripts/build-profile.sh" "YGG_INTEL_ARC_SRIOV_BIND_VFS"
