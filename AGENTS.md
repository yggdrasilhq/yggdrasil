...
-  +  — the HUMAN website (GitHub Pages,
  served from main:/docs). Marketing-tone, no site-private values, ever.
-  (non-site) — AGENT and operator docs: specs, build-system
  laws, incident notes. Technical tone, may reference private knobs by
  name (never values).
